    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Protected Admin APIs (Role ADMIN, SUPER_ADMIN, CONTENT_MANAGER, SUPPORT)
                        .requestMatchers("/api/admin/**").hasAnyRole("ADMIN", "SUPER_ADMIN", "CONTENT_MANAGER", "SUPPORT")
                        // Protected Student, Certificate, Placement Kit & Payment APIs (Roles STUDENT or Admin roles)
                        .requestMatchers("/api/student/**").hasAnyRole("STUDENT", "ADMIN", "SUPER_ADMIN", "CONTENT_MANAGER", "SUPPORT")
                        .requestMatchers("/api/payments/**").hasAnyRole("STUDENT", "ADMIN", "SUPER_ADMIN", "CONTENT_MANAGER", "SUPPORT")
                        .requestMatchers("/api/certificates/**").hasAnyRole("STUDENT", "ADMIN", "SUPER_ADMIN", "CONTENT_MANAGER", "SUPPORT")
                        .requestMatchers("/api/placement-kits/**").hasAnyRole("STUDENT", "ADMIN", "SUPER_ADMIN", "CONTENT_MANAGER", "SUPPORT")
