        ...
        quizzes: [
          {
            ...
            slug: 'module-1-quiz',
            description: 'Test your understanding of algorithmic complexity and the two-pointer technique (10 Questions, 80% to pass).',
        ...
        quizzes: [
          {
            ...
            description: 'Test your mastery of recursive traversals and graph algorithms (10 Questions, 80% to pass).',
            minPassScorePercentage: 80,
            quizType: 'MODULE_QUIZ',
            curriculumLevel: 'INTERMEDIATE',
            status: 'PUBLISHED',
        ...
        quizzes: [
          {
            ...
            description: 'Test your understanding of state transitions and memoization (10 Questions, 80% to pass).',
            minPassScorePercentage: 80,
            quizType: 'MODULE_QUIZ',
            curriculumLevel: 'ADVANCED',
            status: 'PUBLISHED',
